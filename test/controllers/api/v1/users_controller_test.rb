...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should show user" do
    ...
    assert_equal @user.companies.first.id.to_s, json_response.dig(:data, :relationships, :companies, :data, 0, :id)
    assert_equal @user.companies.first.company_name, json_response.dig(:included, 0, :attributes, :company_name)
  end
